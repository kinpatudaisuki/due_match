### 概要
カードゲームの１つであるデュエル・マスターズのプレイヤーが、<br>
対戦相手やチームメイトを見つけるために、交流を行えるマッチングサイトです。<br>
URL: https://due-match.com
...
#### ⚫︎トーク機能　
　▪︎トークルームの作成/検索<br>
　▪︎文字や画像の投稿、新規メッセージのメール通知<br>
　▪︎トークルームへ他ユーザーを招待

#### ⚫︎フレンド機能
　▪︎一覧表示<br>
　　・フレンドになったユーザー一覧<br>
　　・自分からフレンド申請したユーザー一覧<br>
　　・フレンド申請された相手ユーザー一覧<br>
　▪︎フレンド申請<br>
　▪︎フレンド申請承認/拒否<br>
　▪︎フレンド解除<br>
...
#### ⚫︎ブロック機能
　▪︎ユーザーのブロック<br>
　　・メッセージの非表示、メール通知をオフ<br>
　　・フレンド申請とフレンド関係の削除<br>
　▪︎ブロック解除

#### ⚫︎運営への問い合わせ機能
　▪︎運営への問い合わせメールの作成・送信<br>
　▪︎運営と質問者に問い合わせ作成成功のメール通知
